...
params = 'appkey=84956560bc028eb7&cid={}&otype=xml&qn={}&quality={}&type='.format(cid, quality,
                                                                                  quality)  # otype=json也行!!
...
for i in video_list:
    ...
    urllib.request.urlretrieve(url=i, filename=r'./bilibili_video/{}/{}-{}.flv'.format(title, title, num),
